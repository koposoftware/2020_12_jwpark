...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
	<div class="container" style="padding-left : 70px">
		<a class="navbar-brand" href="${pageContext.request.contextPath}/teller"><img src="${ pageContext.request.contextPath }/resources/images/hanalogo.png" style="width:150px; height:40px;"></a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav ml-auto">
			<c:choose>
				<c:when test="${ tellerVO.empNo != null }">
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="float: right; font-size: large;">
							${ tellerVO.name }님 환영합니다.
						</a>
						<div class="dropdown-menu dropdown-menu-right animate slideIn" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="#">Action</a>
							<a class="dropdown-item" href="#">Another action</a>
							<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="${pageContext.request.contextPath}/teller/logout">로그아웃</a>
						</div>
					</li>
				</c:when>
				<c:otherwise>
					<a href="${pageContext.request.contextPath}/teller/login" style="padding-right: 30px; font-size: x-large;">로그인</a>
				</c:otherwise>
			</c:choose>
		</ul>
	</div>
