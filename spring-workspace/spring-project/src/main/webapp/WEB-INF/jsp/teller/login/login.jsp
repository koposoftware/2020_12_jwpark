    			...
    			<div class="col-md-7">
    				...
    				<form class="form-horizontal" action="${pageContext.request.contextPath }/teller/login" method="post" name="lForm" >
						...
						<div class="input-group input-group-lg">
  							...
  							<input type="text" class="form-control" aria-label="Large" id="empNo" name="empNo" maxlength="20" placeholder="사번을 입력해주세요" autocomplete="off" aria-describedby="inputGroup-sizing-sm">
						</div>
						<br>
						<div class="input-group input-group-lg">
  							<div class="input-group-prepend">
